...
* syntax, [ country(string) iso(numlist) year(numlist) circa(numlist) water(string) elect(string) SEWage(string) INTERnet(string) CELular(string) pric(string) ATTendance(string) spouse(string) male(string) gmd sedlac] // Variables for HOI can be chosen by user, gmd variable names
...
tempfile hoi
tempname h
postfile `h' country  circa year str48 indicator obs_indicator double (prob dindex hoi sehoi)  using `hoi', replace	// HOI	
	...
	foreach dep in `depvar1' {	// loop for opportunities group # 1
		...
		if `r(r)' == 2 {	// loop if opportunity is defined
			...
			*** HOI - All the sample
			...
			post `h' (`iso') (`circa') (`year') ("`label'") (`e(N)') (`r(p_1)') (`r(d_1)') (`r(hoi_1)') (`r(se_oi_1)')
	...
	foreach dep in `depvar2' {	// loop for opportunities group # 2
		...
		if `r(r)' == 2 {	// loop if opportunity is defined
			...
			*** HOI
			...
			post `h' (`iso') (`circa') (`year') ("School Enrollment") (`e(N)') (`r(p_1)') (`r(d_1)') (`r(hoi_1)') (`r(se_oi_1)')
...
*****************************************************************	
	foreach dep in `depvar3' {	// loop for opportunities group # 3
		...
		if `r(r)' == 2 {	// loop if opportunity is defined
			...
			post `h' (`iso') (`circa') (`year') ("Finished primary School") (`e(N)') (`r(p_1)') (`r(d_1)') (`r(hoi_1)') (`r(se_oi_1)')
