...
====================================================================*/
if "`filter'"!="" {  // 
noi di in red "Autolel defauls 43: hola - erase"
...
====================================================================*/
noi di in white "TEMP autolel_defaults line 279: survey - `survey'"
if "`comp_gic'"!= "" {
	noi di in white "TEMP autolel_defaults line 281: survey - `survey'"
