...
****
* NATALIA - NOV 2019 - adecomp1 => stops program if equation doesn't match. 
...
cap program drop adecomp1
program define adecomp1, rclass sortpreserve byable(recall)
	version 12, missing
